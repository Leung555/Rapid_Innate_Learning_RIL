...
X_R1, X_R2, X_R3, X_L1, X_L2, X_L3 = [], [], [], [], [], []
Y_R1, Y_R2, Y_R3, Y_L1, Y_L2, Y_L3 = [], [], [], [], [], []
...
def sensing_step():
    ...
    global X_R1, X_R2, X_R3, X_L1, X_L2, X_L3, Y_R1, Y_R2, Y_R3, Y_L1, Y_L2, Y_L3 # Added R3, L3
    ...
    if not learned and ver_learned and timeStep > 1:
        if babbling_state:
            ...
            X_R3.append([jointVelR3[0], jointVelR3[1], jointVelR3[2]]) # Added
            Y_R3.append([linearVelocityR3[0], linearVelocityR3[1], linearVelocityR3[2]]) # Added
            ...
            X_L3.append([jointVelL3[0], jointVelL3[1], jointVelL3[2]]) # Added
            Y_L3.append([linearVelocityL3[0], linearVelocityL3[1], linearVelocityL3[2]]) # Added
            ...
            if joint_state > joint_num and counter > rebased_time - 2:
                ...
                W_R3 = _calculate_W(np.array(X_R3), np.array(Y_R3)) # Added
                W_L1 = _calculate_W(np.array(X_L1), np.array(Y_L1))
                W_L2 = _calculate_W(np.array(X_L2), np.array(Y_L2))
                W_L3 = _calculate_W(np.array(X_L3), np.array(Y_L3)) # Added
